...
public class ConsultaLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * ArrayList<Usuario> usuarios = new ArrayList<>(); while (resultSet.next()) {
		 * String nombre = resultSet.getString("nombre"); String apellido =
		 * resultSet.getString("apellido"); Usuario usuario = new Usuario(nombre,
		 * apellido); usuarios.add(usuario); }
		 * 
		 */
