...
public class AltaLoginFoto extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String filename = Paths.get(filePart.getSubmittedFileName()).getFileName().toString(); // Obtén el nombre del
																								// archivo

		// El directorio donde se guardarán los archivos cargados.
		// Esto se puede hacer configurable a través de la configuración de la
		// aplicación.
