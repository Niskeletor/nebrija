 ...
 * <p>
 * Esta clase proporciona un método para obtener una conexión a la base de
 * datos, lo que facilita la interacción con la base de datos para las
 * operaciones de consulta y actualización.
 */
public class DBConexion {
	/**
	 * La instancia de la conexión a la base de datos. haciendo uso del patrón
	 * Singleton
	 */
	 ...
	 * <p>
	 * En función del valor del parámetro bbdd, se seleccionará una u otra base de
	 * datos (para implementar en el futuro).
	 *
	 * @param bbdd un entero que indica la base de datos a la que se quiere
	 *             conectar.
	 * @return una instancia de Connection que representa la conexión a la base de
	 *         datos.
	 * @throws SQLException si hay un error al establecer la conexión con la base de
	 *                      datos.
	 */
